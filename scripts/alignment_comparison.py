...
class DataManager:
    ...
    def load_special_event_logs(self, name="outliers"):
        evaluate_event_logs = []
        path = f"/home/matthias/rwth/ba/process-tree-alignments-cpp/data/{name}/main.csv"
...
def main():
    ...
    # evaluate_event_logs = data_manager.load_special_event_logs("normals")
